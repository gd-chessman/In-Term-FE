...
${data.ps_option_3 ? `<p style="position:absolute;top:52.8rem;left:50%;transform:translateX(-50%);white-space:nowrap;font-weight:bold" class="ft12-inter">${data.ps_option_3}</p>` : ''}
</div>
</body>
</html>`;
}; 