...
<img width="100%" height="100%" src="/a4.png" alt="background image"/>
<p style="position:absolute;top:12rem;left:13.5625rem;white-space:nowrap" class="ft10">${data.pt_brand}</p>
...
<p style="position:absolute;top:30rem;left:25.9375rem;white-space:nowrap" class="ft15">${data.price}</p>
<p style="position:absolute;top:42.25rem;left:6.25rem;white-space:nowrap" class="ft17">${data.price_sale}</p> 
