export const v2Template = (data: {
  ...
  // Xử lý quantity với validation
  const quantity = Math.min(Math.max(data.quantity || 6, 1), 6); // Min: 1, Max: 6, Default: 6
...
<img src="/v2p.png" alt="background image"/>
